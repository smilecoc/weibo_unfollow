...
browser.find_element_by_xpath('//*[@id="loginname"]').clear()#//*[@style]   查找所有包含style的所有元素，所有的属性要加@
...
time.sleep(1)
 #定位悬停时的元素
#browser.move_to_element(browser.find_element_by_link_text("设置")).perform()     通过文本定位元素
